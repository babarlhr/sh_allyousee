...
class CommonLogLinesEpt(models.Model):
    ...
    woo_customer_data_queue_line_id = fields.Many2one("woo.customer.data.queue.line.ept", string="Woo Customer Queue Line")
    woo_order_data_queue_line_id = fields.Many2one("woo.order.data.queue.line.ept", "Woo Order Queue Line")
    woo_product_queue_line_id = fields.Many2one("woo.product.data.queue.line.ept", string="Woo Product Queue Line")
    woo_coupon_data_queue_line_id = fields.Many2one("woo.coupon.data.queue.line.ept", string="Woo Coupon Queue Line")
