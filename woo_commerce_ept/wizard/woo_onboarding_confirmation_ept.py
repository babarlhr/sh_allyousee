...
class WooOnboardingConfirmation_Ept(models.TransientModel):
    _name = 'woo.onboarding.confirmation.ept'
    _description = 'Woo Onboarding Confirmation'
    ...
    def yes(self):
        ...
        if instance_id:
            ...
            return {
                'effect': {
                    'type': 'rainbow_man',
                    'message': _("Congratulations, You have done All Configurations of Instance : {}".format(instance.name)),
                }
            }
        return {
